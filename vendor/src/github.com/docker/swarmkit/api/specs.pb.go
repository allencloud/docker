...
type ContainerSpec struct {
	...
	// devices specifies the devices service will use.
	Devices []string `protobuf:"bytes,11,rep,name=devices" json:"devices,omitempty"`
}
...
func (m *ContainerSpec) Copy() *ContainerSpec {
	...
	if m.Devices != nil {
		o.Devices = make([]string, 0, len(m.Devices))
		for _, v := range m.Devices {
			o.Devices = append(o.Devices, v)
		}
	}
...
var fileDescriptorSpecs = []byte{
	...
	0x78, 0xd7, 0x65, 0xe0, 0x45, 0x77, 0x5d, 0x7a, 0x55, 0xa0, 0xeb, 0xae, 0xfa, 0x1b, 0xb2, 0xec,
	...
	,
}
